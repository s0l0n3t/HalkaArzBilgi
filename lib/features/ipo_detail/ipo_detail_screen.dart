...
import 'package:halkaarzbilgi/features/ipo_detail/widgets/ipo_detail_skeleton.dart';
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: AnimatedSwitcher(
          ...
          child: isLoading
              ? const IpoDetailSkeleton(key: ValueKey('ipo_detail_skeleton'))
              : SingleChildScrollView(
                  key: const ValueKey('ipo_detail_content'),
